...
pub const EN: Translations = Translations {
    ...
    volume: "Volume", menu_quit: "Quit", menu_show: "Show", open_logs: "Open Application Logs",
...
pub const PT: Translations = Translations {
    ...
    volume: "Volume", menu_quit: "Sair", menu_show: "Mostrar", open_logs: "Abrir Logs da Aplicação",
...
pub const FR: Translations = Translations {
    ...
    volume: "Volume", menu_quit: "Quitter", menu_show: "Afficher", open_logs: "Ouvrir os Logs de l'Application",
...
pub const DE: Translations = Translations {
    ...
    volume: "Lautstärke", menu_quit: "Beenden", menu_show: "Anzeigen", open_logs: "Anwendungsprotokolle öffnen",
...
pub const IT: Translations = Translations {
    ...
    volume: "Volume", menu_quit: "Esci", menu_show: "Mostra", open_logs: "Apri i Log dell'Applicazione",
